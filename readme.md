...
A long time ago, I built apps, but now when I do get to code, it's mostly back-ends and platforms. I seem to write more `.yaml` these days than anything else
